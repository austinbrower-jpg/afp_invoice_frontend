...
may be stored in localStorage under a single key, per
docs/superpowers/specs/2026-07-16-cockpit-customization-design.md. The in-progress clock (start
time, date, location) may be stored under one key `afp.clock.v1`, cleared on clock-out; completed
